...
thresh_otsu = cv2.threshold(slice_img, 0, 255, cv2.THRESH_OTSU)[1]
...
titles = ['Original', 'Otsu', 'Adaptive Mean', 'Adaptive Gaussian']
images = [slice_img, thresh_otsu, thresh_adaptive_mean, thresh_adaptive_gauss]
